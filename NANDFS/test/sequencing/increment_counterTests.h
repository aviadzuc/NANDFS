...
#ifndef INCREMENT_COUNTERTESTS_H_
#define INCREMENT_COUNTERTESTS_H_
 ...
 */
error_t runAllincrement_counterTests(void);
 ...
 */
error_t init_increment_counterTest(void);
 ...
 */
error_t tearDown_increment_counterTest(void);
 ...
 */	
error_t increment_counterTest1(void);
 ...
 * change one counter and verify it was indeed changed
 */	
error_t increment_counterTest2(void);
 ...
 */	
error_t increment_counterTest3(void);
 ...
 * @return 1 if successful, 0 otherwise
 */	
error_t increment_counterTest4(void);
...
#endif /*INCREMENT_COUNTERTESTS_H_*/
