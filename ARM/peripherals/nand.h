...
#define POWER_NAND_PAGE_SIZE		  9
#define NAND_PAGE_SIZE				  (1 << POWER_NAND_PAGE_SIZE) /* 512 */
#define POWER_NAND_PAGES_PER_ERASE_UNIT 5  /* 32*/
#define NAND_PAGES_PER_ERASE_UNIT     (1 << POWER_NAND_PAGES_PER_ERASE_UNIT) /* 32 */
#define POWER_NAND_SPARE_SIZE		  4
#define NAND_SPARE_SIZE               (1 << POWER_NAND_SPARE_SIZE) /* 16 */
...
#define NAND_EU_MASK	   0xffffffe0 // 00000000 00000000 11111111 11100000
#define MAX_DEVICE_ACTIONS 4000000000
...
#define NAND_BAD_EU_FLAG_BYTE_NUM     (BAD_EU_BYTE_LOCATION+1)
...
/**
 * @brief
 * mark eu as bad. mark matching byte in spare area of the 1st
 * page of page_addr's eu
 * @return 0 if successful, 1 if the program failed
 */
